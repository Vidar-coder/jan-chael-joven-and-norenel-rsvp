            ...
            <div className="bg-motif-cream/95 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-8 shadow-[0_18px_45px_rgba(0,0,0,0.45)] h-full flex flex-col justify-start border border-motif-deep">
              <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-3 md:gap-4">
                  ...
                  >
                    <Image src="/mobile-background/couple (6).webp" alt="Wedding moment 1" fill className="object-cover" style={{ imageOrientation: "from-image" }} />
                  </motion.div>
                  <motion.div
                    className="relative aspect-square rounded-lg sm:rounded-xl overflow-hidden shadow-md border-2 border-motif-medium/30 hover:border-motif-medium/50 transition-all"
                    whileHover={{ scale: 1.03 }}
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/mobile-background/couple (11).webp" alt="Wedding moment 2" fill className="object-cover" style={{ imageOrientation: "from-image" }} />
                  </motion.div>
                  <motion.div
                    ...
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/desktop-background/couple (1).webp" alt="Wedding moment 3" fill className="object-cover" />
                  </motion.div>
                </div>
                <p
